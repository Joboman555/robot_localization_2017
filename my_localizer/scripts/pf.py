...
class ParticleFilter:
    ...
    def resample_particles(self, particles):
        ...
        if (np.size(most_likely_particle) == 1):
            ...
            pose_most_likely = convert_pose_to_xy_and_theta(most_likely_particle.as_pose())
            reinitialized_particles = self.initialize_particle_cloud(pose_most_likely, num_to_reinit, most_likely_particle.w * 0.9)
        else:
            print 'Number of most likely particles: ' + str(np.size(most_likely_particle))
    ...
    def update_initial_pose(self, msg):
        ...
        self.particle_cloud = normalize_particles(self.initialize_particle_cloud(xy_theta))
        self.update_robot_pose(self.particle_cloud)
        self.fix_map_to_odom_transform(msg)

    def initialize_particle_cloud(self, xy_theta=None, num_particles=None, weight=None):
        ...
        particle_cloud = [Particle(x, y, theta, weight) for (x, y, theta) in zip(xs, ys, thetas)]
    ...
    def scan_received(self, msg):
        ...
        if not(self.particle_cloud):
            ...
            self.particle_cloud = normalize_particles(self.initialize_particle_cloud())
            self.update_robot_pose(self.particle_cloud)
